...
输出 JSON 数组:"""
    ...
    _PATTERN_MAP: List[dict] = [
        ...
        {"skill_id": "debug_api",
         "patterns": ["api报错", "api错误", "接口报错", "接口错误", "接口调试", "http状态码",
                       "请求失败", "调用接口", "rest报错", "restful", "401", "403", "404", "500",
                       "接口返回", "api调用失败", "axios报错", "fetch报错", "requests报错",
                       "response错误", "api debug", "debug api", "postman"]},
        {"skill_id": "debug_web_frontend",
         "patterns": ["前端报错", "前端调试", "react报错", "vue报错", "js报错", "javascript报错",
                       "typescript报错", "css问题", "html问题", "dom报错", "webpack报错",
                       "控制台报错", "console.error", "前端bug", "浏览器报错", "前端错误",
                       "react error", "vue error", "next.js报错", "vite报告",
                       "前端页面", "页面报错", "前端问题", "前端一直报"]},
        {"skill_id": "debug_performance",
         "patterns": ["性能问题", "性能慢", "响应慢", "内存泄漏", "cpu占用高", "内存占用高",
                       "卡顿", "超时", "timeout", "memory leak", "性能优化调试",
                       "慢查询", "程序卡", "资源占用", "性能分析", "profiling", "瓶颈",
                       "性能很慢", "系统很慢", "加载慢", "接口很慢", "响应很慢",
                       "匚慢了", "很慢了", "加载很慢", "cpu太高", "内存太高"]},
        {"skill_id": "debug_python",
         "patterns": ["python报错", "python错误", "python调试", "python异常", "python bug",
                       "traceback", "python debug", "调试python", "python崩溃",
                       "调试", "报错", "bug", "错误", "异常", "debug", "error", "exception"]},
        ...
        {"skill_id": "annotate_business",
         "patterns": ["商务报告批注", "合同修改", "公文批注", "商业文档批注", "对外报告批注",
                       "商务文案批注", "合同审查", "批注商务", "商务文件批注"]},
        ...
        {"skill_id": "workspace_context",
         "patterns": ["当前目录", "项目结构", "我的项目", "工程目录", "工作目录", "工作区",
                       "这个项目", "项目文件", "目录结构", "文件夹结构", "扫描目录",
                       "workspace", "project structure", "current directory", "项目里有哪些"]},
        # ── 文档摘要 ──
        {"skill_id": "doc_summarizer",
         "patterns": ["总结文档", "文档摘要", "帮我看文档", "帮我看看这个文档", "这个文档说了什么",
                       "文件摘要", "总结一下这个文件", "概括文档", "文档主要内容",
                       "summarize document", "document summary", "帮我读一下", "帮我了解这个文档",
                       "文档内容是什么", "这份文件讲了什么"]},
        # ── 文件管理工具 ──
        {"skill_id": "archive_assistant",
         "patterns": ["整理文件", "归档文件", "文件归档", "清理下载", "文件夹整理", "整理文件夹",
                       "整理桌面", "清理桌面", "自动分类文件", "文件自动整理", "批量整理",
                       "归纳文件", "organize files", "file organization", "整理资料"]},
        {"skill_id": "file_duplicate_hunter",
         "patterns": ["重复文件", "找重复", "清理磁盘", "磁盘空间", "释放空间", "删重复",
                       "duplicate files", "找出重复", "相同文件", "占用空间太大", "磁盘清理"]},
        {"skill_id": "file_smart_rename",
         "patterns": ["批量重命名", "重命名文件", "文件重命名", "整理文件名", "规范命名",
                       "rename files", "文件名整理", "批量改名", "照片重命名", "图片重命名"]},
