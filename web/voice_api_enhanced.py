    ...
    try:
        ...
        for cmd_name, cmd in processor.commands.items():
            commands_list.append({
                ...
                "enabled": cmd.enabled,
                "action": cmd.action.__name__ if hasattr(cmd.action, '__name__') else str(cmd.action)
            })
    ...
    try:
        ...
        return jsonify({
            ...
            "config": {
                ...
                "enabled": manager.listener.is_running() if hasattr(manager, 'listener') else False,
