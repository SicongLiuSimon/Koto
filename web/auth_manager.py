...
class RoleManager:
    ...
    def create_role(self, role_id: str, name: str, permissions: Set[Permission]) -> Role:
        """Create custom role"""
        role = Role(
            role_id=role_id,
...
class UserManager:
    ...
    def create_user(self, user_id: str, username: str, email: str,
                   password_hash: str, roles: List[UserRole] = None) -> User:
        """Create new user"""
        user = User(
            user_id=user_id,
            username=username,
...
class AuditLogger:
    ...
    def log_action(self, entry_id: str, user_id: str, action: str, resource: str,
                  old_value: Dict = None, new_value: Dict = None,
                  status: str = "success", ip_address: str = "") -> AuditLogEntry:
        """Log action"""
        entry = AuditLogEntry(
            entry_id=entry_id,
            user_id=user_id,
...
if __name__ == "__main__":
    ...
    auth.audit_logger.log_action(
        "audit_001", "usr_001", "login", "user_session",
